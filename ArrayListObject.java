...
public class ArrayListObject {
	...
	public static void main(String[] args) {
		...
		isi.add(new ArrayListObject("Alfandhy","D0217034","Informatika E","Pelitakan City"));
		isi.add(new ArrayListObject("PloySornarin","53453453","informatika E","THAILAND"));
		isi.add(new ArrayListObject("NAT","56434","informatika E","AFRIKA"));
